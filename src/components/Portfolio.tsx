...
interface LocalProject {
  ...
  estado: 'Desplegado' | 'En Construcción' | 'Próximamente' | 'A la venta'
  href: string
  tags: string[]
  order: number
}
      ...
      <div className="container mx-auto max-w-6xl" ref={ref}>
        ...
        {loading ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
            {proyectos.filter(p => p.estado !== 'A la venta').map((proyecto, index) => (
            <motion.div
              key={proyecto.id}
              initial={{ y: 30 }}
              animate={inView ? { y: 0 } : {}}
        ...
        {/* Sección: Proyectos a la venta */}
        {!loading && proyectos.filter(p => p.estado === 'A la venta').length > 0 && (
          <>
            <motion.div
              initial={{ y: 20 }}
              animate={inView ? { y: 0 } : {}}
            ...
            >
              ...
              >
                Proyectos listos que tenemos a la venta
              </p>
            </motion.div>
